                    ...
                    {!user ? 's' :
                        user.map(ok => (
                            <div key={ok.id}>
                                ...
                                <p>Số điện thoại:&emsp; <b><i></i>{ok.phone}</b></p>
                                <p>Giới tính:&emsp; <b><i>{ok.sex === 1 ? "Nam" : "Nữ"}</i></b></p>
                                <p>Ngày sinh:&emsp; <b><i>{ok.dateOfBirth}</i></b></p>
                                <p>Địa chỉ:&emsp; <b><i>{ok.address}</i></b></p>
                            </div>
                        ))
                    }
                </div>
